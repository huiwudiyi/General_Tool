...
# 相关执行class
from tool_description_optimizer.common.passk.nn_server_passk import recall_passk_function
try:
...
class ToolOptimizerGraph:
    ...
    def statistic_check_tool(self, 
        ...
        detaildf = recall_passk_function(self.tools_dict, self.query_good_dict, self.resource_id, statistic_output, eval_view=self.eval_view)
