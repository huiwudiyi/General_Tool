...
resource_ids_all = []
for path in list_file(Const.PATH.value + "summary_out/"):
...
for resource_id, value in query_good_all_dict.items():
    ...
    try:
        dag = ToolOptimizerGraph(resource_id = resource_id,
            ...
            tools_description_path = Const.PATH.value + "summary/tool_description.json",
        ...
        save_pickle(state, Const.PATH.value + + "summary_out/" + resource_id + ".pkl")  
    except:
        continue